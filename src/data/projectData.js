...
export const projectsList = [ // eslint-disable-line
  {
    ...
    desc: 'Developed the front end for this next-generation networking service.',
    color: '#9CCDA1',
  ...
  {
    name: 'N-able Resource Center',
    desc: 'Designed and developed the new customer portal for Solarwinds N-able.',
    color: '#9CCDA1',
    imgSource: '/img/projects/nrc-dash.png',
    techStack: [
      {name: 'Kentico', icon: 'devicons devicons-css_tricks', color: '#E86F32' },
      {name: 'JavaScript', icon: 'devicons devicons-javascript', color: '#0062A8' },
      {name: 'HTML', icon: 'devicons devicons-html5', color: '#EE8407' },
      {name: 'CSS Grid', icon: 'devicons devicons-css3', color: '#4173D5' },
      {name: 'Bootstrap', icon: 'devicons devicons-bootstrap', color: '#563D7C' },
    ],
    actionLinks: [
      {name: "View on Web", icon: "monitor", url: "https://nrc.n-able.com"}
    ]
  },
  {
    name: 'Personal Site',
  ...
  {
    name: 'Solarwinds N-able Business Assessment Tool',
    desc: 'An online tool for assessing the business of Solarwinds N-ables potential customers.',
    color: '#9CCDA1',
  ...
  },
  {
    ...
    techStack: [
      {name: 'Wordpress', icon: 'devicons devicons-wordpress', color: '#3DAEFF' },
      {name: 'PHP', icon: 'devicons devicons-php', color: '#0062A8' },
      {name: 'WooCommerce', icon: 'devicons devicons-woocommerce', color: '#7C2ACF' },
    ],
    actionLinks: [
      {name: "View on Web", icon: "monitor", url: "http://www.asilisoaps.ca"},
    ]
  },
  {
    name: 'Liz Vittorini',
    desc: 'A website for a local real estate agent.',
    color: '#6e82b0',
    imgSource: '/img/projects/liz.png',
    techStack: [
      {name: 'Wordpress', icon: 'devicons devicons-wordpress', color: '#3DAEFF' },
      {name: 'PHP', icon: 'devicons devicons-php', color: '#0062A8' },
    ],
    actionLinks: [
      {name: "View on Web", icon: "monitor", url: "http://www.lizvittorini.com"},
    ]
  },
  {
    name: 'Graphite Software - Secure Spaces',
  ...
  },
  {
    ...
    desc: 'A website for a hydroseeding business in the National Captial Region.',
    color: '#6e82b0',
